...
/*   Updated: 2024/05/31 00:51:42 by dnovak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// of the string they tried to create. For strlcpy() that means the length of
// src. For strlcat() that means the initial length of dst plus the length of
